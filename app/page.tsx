...
const products: Product[] = [
  ...
  // Babysec - Size P (Small)
  {
    ...
    price: "R$ 35,09",
    category: "Fraldas",
    description: "Fralda com proteção confiável e ajuste confortável para o dia a dia",
  ...
  // Pampers - Size RN (Newborn)
  {
    ...
    price: "R$ 66,90",
    category: "Fraldas",
    description: "Fralda premium com absorção superior e pele sequinha por até 12 horas",
  ...
  // MamyPoko - Size RN (Newborn)
  {
    ...
    price: "R$ 34,90",
    category: "Fraldas",
    description: "Fralda macia com excelente custo-benefício e ótima absorção",
  ...
  // ========================================
  {
    ...
    description: "Kit com pomada multifuncional e antiassaduras. Fórmula 100% natural que protege e alivia a pele do bebê",
  ...
  },
  {
    ...
    category: "Mimos",
    subcategory: "Cuidados",
    description: "Kit compacto de viagem com pomadas multifuncional e antiassaduras. Proteção natural para onde você for",
    image: "/images/products/Booma_Kit-Pomadas_100ml.jpeg",
  },
  ...
  {
    id: 202,
    brand: "Cadeira de Balanço Automática",
    size: "Único",
    count: "1 unidade",
    price: "R$ 577,00",
    category: "Mimos",
    subcategory: "Equipamentos",
    description: "Cadeira de balanço automática com design ergonômico, cinto de segurança ajustável e assento acolchoado para conforto e tranquilidade",
  ...
  {
    id: 203,
    brand: "Mordedor de Silicone",
    size: "Único",
    count: "1 unidade",
    price: "R$ 29,00",
    category: "Mimos",
    subcategory: "Brinquedos",
    description: "Mordedor de silicone macio e seguro para aliviar o desconforto da dentição",
    image: "/images/products/No-Brand_Mordedor_Tipo1.jpeg",
  },
  {
    id: 204,
    brand: "Conjunto Educativo Montessori",
    size: "Único",
    count: "16 peças",
    price: "R$ 52,00",
    category: "Mimos",
    subcategory: "Brinquedos",
    description: "Conjunto educativo com formas coloridas para reconhecimento e desenvolvimento cognitivo",
    image: "/images/products/No-Brand_Brinquedo_Tipo1.jpeg",
  },
  {
    id: 205,
    brand: "Livros de Tecido para Bebê",
    size: "Único",
    count: "4 peças",
    price: "R$ 62,00",
    category: "Mimos",
    subcategory: "Brinquedos",
    description: "Livros de tecido educativos e sensoriais, laváveis e seguros para recém-nascidos",
    image: "/images/products/No-Brand_Brinquedo_Tipo2.jpeg",
  },
  {
    id: 206,
    brand: "Mordedor Dinossauro",
    size: "Único",
    count: "1 unidade",
    price: "R$ 28,76",
    category: "Mimos",
    subcategory: "Brinquedos",
    description: "Mordedor de madeira e silicone com design de dinossauro, fácil de segurar e perfeito para dentição",
    image: "/images/products/No-Brand_Mordedor_Tipo2.jpeg",
  },
  {
    id: 207,
    brand: "Casa Sensorial de Pelúcia",
    size: "Único",
    count: "1 unidade",
    price: "R$ 99,00",
    category: "Mimos",
    subcategory: "Brinquedos",
    description: "Brinquedo sensorial de pelúcia para reconhecimento de cores e animais, ajuda no desenvolvimento motor",
    image: "/images/products/No-Brand_Brinquedo_Tipo3.jpeg",
  },
  {
    id: 208,
    brand: "Kit Brinquedos de Praia",
    size: "Único",
    count: "8 peças",
    price: "R$ 115,00",
    category: "Mimos",
    subcategory: "Brinquedos",
    description: "Kit de praia com balde, pá, moldes de areia e bolsa. Perfeito para verão e atividades ao ar livre",
    image: "/images/products/No-Brand_Brinquedo_Tipo4.jpeg",
  },
  {
    id: 209,
    brand: "Bóia Infantil com Cobertura",
    size: "Único",
    count: "1 unidade",
    price: "R$ 52,59",
    category: "Mimos",
    subcategory: "Brinquedos",
    description: "Bóia inflável com cobertura solar, alças e design anti-tombamento para segurança na piscina",
  ...
  {
    id: 210,
    brand: "Cozy Pixies Babadores de Silicone",
    size: "Único",
    count: "2 peças",
    price: "R$ 34,99",
    category: "Mimos",
    subcategory: "Alimentação",
    description: "Babadores impermeáveis de silicone com design de animais, práticos e fáceis de limpar",
    image: "/images/products/Cozy-Pixies_Kit-Babadores_2.jpeg",
  },
  {
    id: 211,
    brand: "Cozy Pixies Kit de Alimentação",
    size: "Único",
    count: "5 peças",
    price: "R$ 80,99",
    category: "Mimos",
    subcategory: "Alimentação",
    description: "Kit completo de alimentação com tigelas de sucção, babador, garfo e colher",
    image: "/images/products/Cozy-Pixies_Kit-Alimentacao_1.jpeg",
  },
  {
    id: 212,
    brand: "Potes de Vidro para Armazenamento",
    size: "Único",
    count: "5 potes",
    price: "R$ 45,00",
    category: "Mimos",
    subcategory: "Alimentação",
    description: "Potes de vidro seguros e práticos para armazenar leite materno e papinhas",
  ...
  {
    id: 213,
    brand: "Cozy Pixies Trocador Portátil",
    size: "Único",
    count: "1 unidade",
    price: "R$ 63,99",
    category: "Mimos",
    subcategory: "Acessórios",
    description: "Trocador portátil impermeável e dobrável, perfeito para passeios e viagens",
    image: "/images/products/Cozy-Pixies_Trocador-Portatil_1.jpeg",
  },
  {
    id: 214,
    brand: "Cozy Pixies Bolsa Maternal",
    size: "Único",
    count: "1 unidade",
    price: "R$ 123,24",
    category: "Mimos",
    subcategory: "Acessórios",
    description: "Bolsa maternal multifuncional com grande capacidade, compartimento térmico para mamadeiras e design prático",
    image: "/images/products/Cozy-Pixies_Mochila_1.jpeg",
  },
  {
    id: 215,
    brand: "Cozy Pixies Capa para Carrinho",
    size: "Único",
    count: "1 unidade",
    price: "R$ 57,99",
    category: "Mimos",
    subcategory: "Acessórios",
    description: "Capa respirável para carrinho com proteção solar, contra poeira, vento e insetos",
    image: "/images/products/Cozy-Pixies_Capa-Carrinho_1.jpeg",
  },
  {
    id: 216,
    brand: "Cozy Pixies Saco de Dormir",
    size: "Único",
    count: "1 unidade",
    price: "R$ 40,39",
    category: "Mimos",
    subcategory: "Acessórios",
    description: "Saco de dormir macio e confortável com tecido delicado para a pele do bebê",
    image: "/images/products/Cozy-Pixies_Saco-Dormir_1.jpeg",
  },
  {
    id: 217,
    brand: "Cozy Pixies Cobertor Térmico",
    size: "Único",
    count: "1 unidade",
    price: "R$ 52,49",
    category: "Mimos",
    subcategory: "Acessórios",
    description: "Cobertor térmico de camada dupla com aplicação de urso, ideal para manter o bebê quentinho",
  ...
  {
    id: 218,
    brand: "Cozy Pixies Conjunto Morango",
    size: "RN",
    count: "4 peças",
    price: "R$ 80,59",
    category: "Mimos",
    subcategory: "Roupas",
    description: "Conjunto adorável com 4 peças em cor rosa suave, perfeito para recém-nascidos",
    image: "/images/products/Cozy-Pixies_Kit-Roupa_1.jpeg",
  },
  {
    id: 219,
    brand: "Cozy Pixies Tênis Infantil",
    size: "Único",
    count: "1 par",
    price: "R$ 71,99",
    category: "Mimos",
    subcategory: "Roupas",
    description: "Tênis macio com estampa de coração, biqueira anti-colisão e sola antiderrapante",
    image: "/images/products/Cozy-Pixies_Tenis_1.jpeg",
  },
  {
    id: 220,
    brand: "Cozy Pixies Mocassins",
    size: "Único",
    count: "1 par",
    price: "R$ 75,59",
    category: "Mimos",
    subcategory: "Roupas",
    description: "Mocassins confortáveis e fofos, perfeitos para o uso diário do bebê",
  ...
  {
    id: 221,
    brand: "Natura Kit Mamãe e Bebê",
    size: "200ml",
    count: "4 produtos",
    price: "R$ 202,00",
    category: "Mimos",
    subcategory: "Cuidados",
    description: "Kit Natura com shampoo, condicionador, sabonete em barra e hidratante para cuidado completo",
    image: "/images/products/Natura_Kit-Limpeza_200ml.jpeg",
  },
  {
    id: 222,
    brand: "Natura Kit Mamãe e Bebê Líquido",
    size: "200ml",
    count: "4 produtos",
    price: "R$ 203,80",
    category: "Mimos",
    subcategory: "Cuidados",
    description: "Kit Natura com shampoo, condicionador, sabonete líquido e hidratante para cuidado completo",
  ...
  {
    id: 223,
    brand: "Johnson's Baby Hidratante Derma Protect",
    size: "200ml",
    count: "1 unidade",
    price: "R$ 63,00",
    category: "Mimos",
    subcategory: "Cuidados",
    description: "Hidratante nutritivo com tecnologia Derma Protect para proteção e nutrição da pele delicada",
  ...
  {
    id: 224,
    brand: "Bepantol Baby Lenços Umedecidos",
    size: "Único",
    count: "192 lenços",
    price: "R$ 45,90",
    category: "Mimos",
    subcategory: "Cuidados",
    description: "Kit promocional Bepantol Baby com lenços umedecidos suaves e dermatologicamente testados",
  ...
  {
    id: 225,
    brand: "Blumee Espuma de Banho",
    size: "210ml",
    count: "1 unidade",
    price: "R$ 69,90",
    category: "Mimos",
    subcategory: "Cuidados",
    description: "Espuma de banho suave e delicada, segura para uso desde o nascimento",
    image: "/images/products/Blumee_Esmupa-Banho_210ml.jpeg",
  },
  {
    id: 226,
    brand: "Blumee Água de Limpeza",
    size: "300ml",
    count: "1 unidade",
    price: "R$ 58,90",
    category: "Mimos",
    subcategory: "Cuidados",
    description: "Água de limpeza suave e hipoalergênica, ideal para recém-nascidos",
    image: "/images/products/Blumee_Agua-Limpeza_300ml.jpeg",
  },
  {
    id: 227,
    brand: "Blumee Kit Recém-Nascido",
    size: "Kit",
    count: "2 produtos",
    price: "R$ 115,90",
    category: "Mimos",
    subcategory: "Cuidados",
    description: "Kit essencial para recém-nascidos com espuma de banho e água de limpeza",
